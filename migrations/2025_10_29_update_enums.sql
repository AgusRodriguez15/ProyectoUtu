...
ALTER TABLE `Gestion` ADD COLUMN `tipo_new` ENUM('baneo','desbaneo','eliminar_usuario','editar_perfil','cambiar_gmail','cambiar_contraseña') NULL;
...
ALTER TABLE `Gestion` CHANGE `tipo_new` `tipo` ENUM('baneo','desbaneo','eliminar_usuario','editar_perfil','cambiar_gmail','cambiar_contraseña') NOT NULL;
